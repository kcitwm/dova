...
namespace Dova
{
    ...
    public class DovaResponse
    {
        ...
        {
            return "Header::TransactionID:" + _transactionID + ",KeyID:" + _keyID + ",Status:" + _status + ",Message:" + _message + ";Body::" + (null==_body?"响应Body为空":_body.ToString());
        }
        
        public  string ToKeyString()
        {
            return "Header::TransactionID:" + _transactionID + ",KeyID:" + _keyID + ",Status:" + _status + ",Message:" + _message;
        }

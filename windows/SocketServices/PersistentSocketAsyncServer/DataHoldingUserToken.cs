...
namespace PersistentSocketAsyncServer
{
    public class DataHoldingUserToken
    {
        ...
        public DataHolder theDataHolderCache;
        ...
        public bool continueReceive = true;
        ...
        { 
            ...
            //this.lengthOfCurrentIncomingMessage = 0;
            this.receiveMessageOffset = this.permanentReceiveMessageOffset; 
        }

        public void ResetSend()
        { 
            this.sendBytesRemainingCount = 0; //添加 
            this.bytesSentAlreadyCount = 0;//添加
            dataToSend = null;
        }
